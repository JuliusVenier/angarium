<script>
    ...
    import FilterList from '../../components/shared/+filterList.svelte';
    ...
    import { LuSave } from "svelte-icons-pack/lu";
...
<div bind:this={scrollElement} class="h-full w-full overflow-y-auto">
    ...
    >
        ...
        <tr class="row" slot="empty" class:hidden={fileList !== null && fileList !== undefined && fileList.length > 0}>
            <td colspan="8">Zur Zeit keine Dokumente vorhanden</td>
        </tr>
        <tr id="rowID_{row.id}" class="row">
            ...
            <td><button class="btn btn-outline btn-error p-2 min-h-0 h-fit tooltip tooltip-bottom tooltip-error" data-tip="Datei löschen" ><Icon src={TrOutlineTrashX} size="32" /></button></td>
        </tr>
    </FilterList>
